  ...
  return (
    <>
      ...
      <div className="contact-grid">
        <div className="container-fadein fadein-left">
        ...
        <div className="fadein-right m-auto">
          <h1
            ...
            } pt-[2rem] pb-[1rem] px-[2rem] max-w-[800px] text-[1.2rem] font-semibold text-center`}
          >
          ...
          <h1
            className={`${
              props.darkMode ? "text-gray-300" : "text-gray-800"
            } p-[1rem] text-[1.2rem] font-semibold text-center`}
          >
          ...
          <p
            ...
            } p-[1rem] text-[1.2rem] font-light text-center`}
          >
            <a
          ...
          <p
            className={`${
              props.darkMode ? "text-yellow-300" : "text-yellow-500"
            } text-[1.2rem] font-light text-center`}
          >
            628 Enterprise St.
          </p>
          <p
